...
- architecture and structure screenshots can be taken from:
  - `lib/` tree
  - architecture section in this README
  - key screens in the running app
- release APK available at `releases/rempo-release.apk`.

## 13) Author Notes

- comments in code are intentionally written in a human style, lowercase, and present-continuous where explanatory comments are needed.
- UI strings avoid emoji usage.
